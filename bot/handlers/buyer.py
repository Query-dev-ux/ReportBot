...
TEMPLATE = (
    ...
    "2. Напишите какие задачи ставили на этот день\n"
    "3. Напишите какие результаты получили по выполненным задачам\n"
    "4. Напишите какие задачи не получилось выполнить и почему"
)
